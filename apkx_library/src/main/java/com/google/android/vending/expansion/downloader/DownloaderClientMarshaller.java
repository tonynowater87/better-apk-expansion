...
public class DownloaderClientMarshaller {
    ...
    private static class Stub implements IStub {
        ...
        private Class<? extends DownloaderService> mDownloaderServiceClass;
        ...
        public Stub(IDownloaderClient itf, Class<? extends DownloaderService> downloaderService) {
            mItf = itf;
            mDownloaderServiceClass = downloaderService;
            if (downloaderService == DownloaderService.class) {
                throw new IllegalArgumentException("Service class must be of type extending " + DownloaderService.class.getName());
            }
        }
        ...
        public void connect(Context c) {
            mContext = c;
            Intent bindIntent = new Intent(c.getApplicationContext(), mDownloaderServiceClass);
            bindIntent.putExtra(PARAM_MESSENGER, mMessenger);
            if ( !c.getApplicationContext().bindService(bindIntent, mConnection, Context.BIND_DEBUG_UNBIND) ) {
                if ( Constants.LOGVV ) {
        ...
        public void disconnect(Context c) {
            if (mBound) {
                c.getApplicationContext().unbindService(mConnection);
                mBound = false;
            }
            mContext = null;
        }
     ...
     */
    public static IStub CreateStub(IDownloaderClient itf, Class<? extends DownloaderService> downloaderService) {
    ...
    public static int startDownloadServiceIfRequired(Context context, PendingIntent notificationClient,
            Class<? extends DownloaderService> serviceClass)
            throws NameNotFoundException {
